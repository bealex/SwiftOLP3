...
extension AdLibDriver {
    ...
    func callParserOpcode(_ op: Int, _ c: Int, _ values: Int) -> Int {
        switch op {
            case 0: return update_setRepeat(c, values)
            case 1: return update_checkRepeat(c, values)
            case 2: return update_setupProgram(c, values)
            case 3: return update_setNoteSpacing(c, values)
            case 4: return update_jump(c, values)
            case 5: return update_jumpToSubroutine(c, values)
            case 6: return update_returnFromSubroutine(c, values)
            case 7: return update_setBaseOctave(c, values)
            case 9: return update_playRest(c, values)
            case 10: return update_writeAdLib(c, values)
            case 11: return update_setupNoteAndDuration(c, values)
            case 12: return update_setBaseNote(c, values)
            case 13: return update_setupSecondaryEffect1(c, values)
            case 14: return update_stopOtherChannel(c, values)
            case 15: return update_waitForEndOfProgram(c, values)
            case 16: return update_setupInstrument(c, values)
            case 17: return update_setupPrimaryEffectSlide(c, values)
            case 18: return update_removePrimaryEffectSlide(c, values)
            case 19: return update_setBaseFreq(c, values)
            case 21: return update_setupPrimaryEffectVibrato(c, values)
            case 26: return update_setPriority(c, values)
            case 28: return update_setBeat(c, values)
            case 29: return update_waitForNextBeat(c, values)
            case 30: return update_setExtraLevel1(c, values)
            case 32: return update_setupDuration(c, values)
            case 33: return update_playNote(c, values)
            case 36: return update_setFractionalNoteSpacing(c, values)
            case 38: return update_setTempo(c, values)
            case 39: return update_removeSecondaryEffect1(c, values)
            case 41: return update_setChannelTempo(c, values)
            case 43: return update_setExtraLevel3(c, values)
            case 44: return update_setExtraLevel2(c, values)
            case 45: return update_changeExtraLevel2(c, values)
            case 46: return update_setAMDepth(c, values)
            case 47: return update_setVibratoDepth(c, values)
            case 48: return update_changeExtraLevel1(c, values)
            case 51: return update_clearChannel(c, values)
            case 53: return update_changeNoteRandomly(c, values)
            case 54: return update_removePrimaryEffectVibrato(c, values)
            case 57: return update_pitchBend(c, values)
            case 58: return update_resetToGlobalTempo(c, values)
            case 59, 64: return update_nop(c, values)
            case 60: return update_setDurationRandomness(c, values)
            case 61: return update_changeChannelTempo(c, values)
            case 63: return updateCallback46(c, values)
            case 65: return update_setupRhythmSection(c, values)
            case 66: return update_playRhythmSection(c, values)
            case 67: return update_removeRhythmSection(c, values)
            case 68: return update_setRhythmLevel2(c, values)
            case 69: return update_changeRhythmLevel1(c, values)
            case 70: return update_setRhythmLevel1(c, values)
            case 71: return update_setSoundTrigger(c, values)
            case 72: return update_setTempoReset(c, values)
            case 73: return updateCallback56(c, values)
            default: return update_stopChannel(c, values)   // 8, 20, 22.. unused slots
        }
    }
    ...
    func update_waitForEndOfProgram(_ c: Int, _ values: Int) -> Int {
        guard let ptr = getProgram(Int(_soundData[values])) else {
            return 0
        }
    ...
    func update_setupInstrument(_ c: Int, _ values: Int) -> Int {
        guard let instrument = getInstrument(Int(_soundData[values])) else {
            return 0
        }
